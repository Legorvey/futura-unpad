...
interface MechaturaProfileSidebarProps {
  isOpen: boolean;
  onToggle: () => void;
  children: React.ReactNode;
}

export default function MechaturaProfileSidebar({
  isOpen,
  onToggle,
  children
}: MechaturaProfileSidebarProps) {
    ...
    <>
      ...
      >
        ...
        <div className={cn(
          ...
          "lg:sticky lg:top-22 lg:h-[calc(100vh-5rem)] scrollbar-thin scrollbar-thumb-border scrollbar-track-transparent hover:scrollbar-thumb-muted-foreground/50"
        )}>
          <div 

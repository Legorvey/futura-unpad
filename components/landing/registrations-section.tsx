    ...
    return (
        <div className="relative group flex flex-col justify-between p-8 md:p-10 rounded-[2.5rem] bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] hover:border-white/10 transition-all duration-300 ease-in-out backdrop-blur-2xl overflow-hidden shadow-xl hover:-translate-y-2 h-full cursor-pointer">
            ...
            <div 
                ...
                style={{
                    background: `radial-gradient(circle at 0% 0%, ${event.accentColor}26 0%, transparent 60%)`
                }}
            />
            ...
            <div 
                ...
                style={{
                    background: `radial-gradient(circle at 0% 0%, ${event.accentColor}66 0%, transparent 70%)`,
            ...
            <div className="relative z-10 flex flex-col flex-grow">
                    ...
                    <div className="flex flex-col gap-5">
                        <div className="flex items-center gap-4">
                            <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center shrink-0 border border-white/5">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: event.accentColor }}><rect width="18" height="18" x="3" y="4" rx="2" ry="2" /><line x1="16" x2="16" y1="2" y2="6" /><line x1="8" x2="8" y1="2" y2="6" /><line x1="3" x2="21" y1="10" y2="10" /></svg>
                            </div>
                        ...
                        <div className="flex items-center gap-4">
                            <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center shrink-0 border border-white/5">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: event.accentColor }}><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z" /><circle cx="12" cy="10" r="3" /></svg>
                            </div>
                            <div className="flex flex-col">
                ...
                <div className="mt-auto flex flex-col gap-8">
                    <div className="p-5 rounded-2xl bg-black/20 border border-white/5 backdrop-blur-sm">
                        <span className="block text-xs font-bold tracking-widest uppercase mb-2" style={{ color: event.accentColor }}>{event.highlights_title}</span>

  ...
  if (isStatic) {
    return (
      <div className={cn("fixed inset-0 pointer-events-none z-[-1] overflow-hidden", className)}>
        {/* Subtle peripheral background elements - reduced count and no glows */}
        <div className="absolute -top-[10%] -left-[10vw] w-[35vw] max-w-[500px] min-w-[280px] aspect-square opacity-[0.06] mix-blend-screen">
          <Image src="/Triangle-bg.png" alt="" fill className="object-contain" priority />
        </div>
        
        <div className="absolute -bottom-[10%] -right-[10vw] w-[35vw] max-w-[500px] min-w-[280px] aspect-square opacity-[0.06] mix-blend-screen">
          <Image src="/Tech-bg.png" alt="" fill className="object-contain" priority />
        </div>
      </div>
    )
  }

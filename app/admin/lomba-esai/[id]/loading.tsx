...
export default function LoadingEsaiDetails() {
    return (
        <div className="mx-auto w-full space-y-6 sm:space-y-8">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                <div className="flex items-start sm:items-center gap-4">
                    ...
                    <div>
                        <h2 className="font-semibold text-xl sm:text-2xl tracking-tight line-clamp-1">Detail Peserta Lomba Esai</h2>
                        <p className="mt-1 text-sm text-muted-foreground">
                            Loading complete details for one Lomba Esai registration...
                        </p>
                    </div>
                </div>
